            ...
            <div class="show_info">
                <div class="disFlex_sb">
                    ...
                    <div class="search disFlex_sb print_BgColor">          
                        <input class="print_BgColor" type="search" id="print_search" onkeyup="searching(id,'print_items')" placeholder="Click to search..." title="Type in a name">
                            ...
                            @foreach ($print_items as $pi)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="del_or_not" href="{{route('sm.print.toDel',['id'=>$pi->printId])}}">
