    ...
    <section>
        ...
        <!-- <div class="small_three" id="dwm">
            <div class="calendar_form">
                <label for="" class="year_month">Choose Year and Month</label>
                <div id="start_end">
                    <div class="date_month left-btn">
                        <button type="button" value="" class="">Choose Date</button>
                        <div class="hide" style="">
                            <li style="padding:10px;" value="" class="twelve_months">2020</li>
                            <li style="padding:10px;" value="" class="twelve_months">2021</li>
                            <li style="padding:10px;" value="" class="twelve_months">2022</li>
                            <li style="padding:10px;" value="" class="twelve_months">2023</li>
                            <li style="padding:10px;" value="" class="twelve_months">2024</li>
                            <li style="padding:10px;" value="" class="twelve_months">2025</li>
                            <li style="padding:10px;" value="" class="twelve_months">2026</li>
                        </div>
                    </div>
        
                    <div class="date_month right-btn">
                        <button type="button" value="" class="">Choose Month</button>
                        <button type="button" value="" class="apply">Apply</button>
                        <div class="hide" style="">
                            <li style="padding:10px;" value="" class="twelve_months">January</li>
                            <li style="padding:10px;" value="" class="twelve_months">Feburary</li>
                            <li style="padding:10px;" value="" class="twelve_months">March</li>
                            <li style="padding:10px;" value="" class="twelve_months">April</li>
                            <li style="padding:10px;" value="" class="twelve_months">May</li>
                            <li style="padding:10px;" value="" class="twelve_months">June</li>
                            <li style="padding:10px;" value="" class="twelve_months">July</li>
                        </div>
        ...
        <div class="hide calendar-month animate__animated animate__slideInUp" id="calendar">
            ...
            <div style="position: relative;">
                ...
                <!-- <label for="">Date Customizing</label> -->
                <!-- 
        ...
        <h1>Total Sale</h1>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#00cba9" fill-opacity="1" d="M0,64L30,90.7C60,117,120,171,180,165.3C240,160,300,96,360,90.7C420,85,480,139,540,144C600,149,660,107,720,112C780,117,840,171,900,165.3C960,160,1020,96,1080,64C1140,32,1200,32,1260,42.7C1320,53,1380,75,1410,85.3L1440,96L1440,0L1410,0C1380,0,1320,0,1260,0C1200,0,1140,0,1080,0C1020,0,960,0,900,0C840,0,780,0,720,0C660,0,600,0,540,0C480,0,420,0,360,0C300,0,240,0,180,0C120,0,60,0,30,0L0,0Z"></path></svg>
                <div>
                <h5>From <span>June 1, 2021<span></span></span>
            
                </h5><i class="fas fa-arrows-alt-h fa-lg"><span>2 days<span></span></span></i><h5>To <span>June 2, 2021<span></span></span></h5>
            <i class="fas fa-equals fa-lg"></i><h5>Receieved Amount<span class="value">0 MMK<span></span></span></h5></div>
            <svg id="wave" style="transform:rotate(0deg); transition: 0.3s" viewBox="0 0 1440 120" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="sw-gradient-0" x1="0" x2="0" y1="1" y2="0"><stop stop-color="rgba(3, 150, 132, 1)" offset="0%"></stop><stop stop-color="rgba(133.818, 222.214, 176.993, 1)" offset="100%"></stop></linearGradient></defs><path style="transform:translate(0, 0px); opacity:1" fill="url(#sw-gradient-0)" d="M0,72L12,62C24,52,48,32,72,24C96,16,120,20,144,36C168,52,192,80,216,78C240,76,264,44,288,44C312,44,336,76,360,92C384,108,408,108,432,100C456,92,480,76,504,